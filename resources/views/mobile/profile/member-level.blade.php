<x-mobile.app>
    <div class="container">
        <h2 class="title">Tingkat Anggota</h2>
        ...
        <div class="member-level">
            <div class="row profile-detail">
                <div class="col-lg-8 col-sm-11 col-xs-12 profile-detail-row">
                    <div class="row">
                        <div class="col-lg-2 col-sm-2 col-xs-5 noSidePadding">Nama pengguna:</div>
                        <div>{{ Auth::user()->username }}</div>
                    </div>
                </div>
                <div class="col-lg-8 col-sm-11 col-xs-12 profile-detail-row">
                    <div class="row">
                        <div class="col-lg-2 col-sm-2 col-xs-5 noSidePadding">Tingkat saat ini:</div>
                        <span class="level-title New">Baru tingkat anggota</span>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="level-progress-bar col-lg-5 col-sm-5 col-xs-11 flex noSidePadding">
                    <div class=""><span class="level-title New">Baru</span></div>
                    <div class="progress col-lg-8 col-sm-8 col-xs-6 noSidePadding">
                        <div class="progress-bar progress-bar-striped New" role="progressbar" aria-valuenow="0.00"
                            aria-valuemin="0" aria-valuemax="100" style="width:0.00%;display:inline-block"></div>
                    </div>
                    <div class=""><span class="level-title Regular">Reguler</span></div>
                </div>
            </div>
                ...
                <div class="col-lg-7 col-sm-7 col-xs-12">
                    <div class="row border-btm">
                        <div class="col-lg-5 col-xs-6 noSidePadding">
                            <div class="col-lg-7 col-sm-7 col-xs-12 noSidePadding fl-right txt-bold txt-highlight">
                                0</div>
                        ...
                        <div class="col-lg-6 col-xs-6 noSidePadding">
                            <div class="col-lg-5 col-sm-5 col-xs-12 noSidePadding fl-right txt-bold txt-highlight">
                                1</div>
                            <div class="col-lg-7 col-sm-7 col-xs-12 noSidePadding grey1">
                                <div class="progress-label">Jumlah Deposit yang Diperlukan untuk Level
                                    Selanjutnya</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row border-btm">
                        ...
                        <div class="col-lg-6 col-xs-6 noSidePadding">
                            <div class="col-lg-5 col-sm-5 col-xs-12 noSidePadding fl-right txt-bold txt-highlight">
                                0</div>
                            <div class="col-lg-7 col-sm-7 col-xs-12 noSidePadding grey1">
                                <div class="progress-label">Jumlah Turnover yang Diperlukan untuk Level
                                    Selanjutnya</div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-7 col-sm-7 col-xs-12">
                    <div class="row border-btm">
                        ...
                        <div class="col-lg-6 col-xs-6 noSidePadding">
                            ...
                            <div class="col-lg-7 col-sm-7 col-xs-12 noSidePadding grey1">
                                <div class="progress-label">Level Kedaluwarsa Jika tidak aktif</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-3 col-sm-4 col-xs-12 level-outer-box">
                        <div class="col-lg-12 col-sm-12 col-xs-3 noSidePadding level-box">
                            <a href="javascript:void(0);" onclick="chg_level(0)">
                                <div class="col-lg-7 col-sm-7 col-xs-12 noSidePadding fl-right txt-bold level-name">
                                    Reguler</div>
                                <div class="col-lg-5 col-sm-5 col-xs-12 noSidePadding">
                                    <img src="https://files.sitestatic.net/assets/imgs/member_level_Regular.png"
                                        width="65" height="65" class="img-fluid center-block level-logo">
                                </div>
                            </a>
                        </div>
                        <div class="col-lg-12 col-sm-12 col-xs-3 noSidePadding level-box">
                    ...
                    <div class="col-lg-6 col-sm-8 col-xs-12 level-desc-box">
                        <div class="col-xs-7 ">
                            <div class="row">
                                <div class="col-xs-12 level-title-box noSidePadding">
                                    <span class="level-title Regular" id="box_level_name">Reguler
                                        tingkat anggota</span>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-7 col-xs-12 noSidePadding grey2">
                                    <p class="_label level-desc-label progress-label" i18n>Akumulasi
                                        Deposit yang Diperlukan</p>
                                </div>
                                <div class="col-lg-5 col-xs-12 noSidePadding grey3 txt-highlight">
                        ...
                        <div class="col-xs-12 validity grey2">
                            Jika dalam <span id="box_validity">2 Tahun</span> tidak melakukan transaksi
                            deposit / Permainan, maka level akan diturunkan secara otomatis </div>
                    </div>
                </div>
            </div>
            <div class="row black-bg-box">
                <div class="row">
                    ...
                    <div class="col-xs-12 ">
                        <p class="gold-title"><span id="exclusive_text">Reguler</span> Eksklusif</p>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-lg-2 col-xs-6">
                        <p><img src="https://files.sitestatic.net/assets/imgs/gold_level.png"
                                class="img-fluid center-block"></p>
                        <p class="txt-center">Buka <span id="unlock_text">Reguler</span> tingkat
                            Promosi/Bonus</p>
                    </div>
                </div>
            </div>
