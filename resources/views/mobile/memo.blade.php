        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-xs-12 memo_tab">
                    <button type="button" class="btn btn-secondary btn_top_memo" style="display: none;">Tulis
                        Memo</button>
                        ...
                        <div class="mdc-tab-scroller">
                            <div class="mdc-tab-scroller__scroll-area mdc-tab-scroller__scroll-area--scroll mdc-tab-scroller__scroll-x"
                                ...
                                <div class="mdc-tab-scroller__scroll-content nav nav-tabs">
                                    <!---->
                                    <a role="tab" mode='1' data-toggle="tab" href="#kotak"
                                        class="mdc-tab mdc-tab--active" aria-selected="false">
                                        <span class="mdc-tab__content">

                                            <span class="mdc-tab__text-label"><!---->KOTAK MASUK<!---->
                                                (<span class="hot">0</span>)</span>
                                    ...
                                    <!---->
                                    <a mode='2' role="tab" data-toggle="tab" href="#terkirim" class="mdc-tab"
                                    ...
                                    <!---->
                                    <a mode='0' role="tab" data-toggle="tab" href="#memo" class="mdc-tab"
                                        aria-selected="false">
                                        <span class="mdc-tab__content">
                    ...
                    <div class="tab-content">
                        <div id="kotak" class="tab-pane fade in active">
                            ...
                            <table id="kotak_table" class="display dataTable" cellspacing="0" width="100%">
                                <col width='3%'>
                                <thead>
                                    <tr>
                                        <th>
                                        ...
                                        <th><span class="memo_select"> Pilih Semua </span>
                                            <button type="button" style="margin-left:8px;"
                                                class="btn btn-primary btn_memo" onclick="check_status('delete')"><i
                                                    class="icon-bin"></i>HAPUS</button>
                                            <button type="button" class="btn btn-secondary btn_memo"
                                                onclick="check_status('read')"><i class="icon-checkmark"></i>TANDA
                                                BACA</button>
                                        </th>
                                    </tr>
                                </thead>
                        ...
                        <div id="terkirim" class="tab-pane fade">
                            <div class="button_table">
                                <button type="button" class="btn btn-primary btn_memo"
                                    onclick="check_status('delete')"><i class="icon-bin"></i>HAPUS</button>
                                <button type="button" class="btn btn-secondary btn_memo"
                                    onclick="check_status('read')"><i class="icon-checkmark"></i>TANDA
                                    BACA</button>
                            </div>
                            <table id="terkirim_table" class="display dataTable" cellspacing="0" width="100%">
                                <col width='3%'>
                                <thead>
                                    <tr>
                                        <th>
                            ...
                            <div class="container-fluid">
                                <div class="row">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="form-group">
                                            <label>JUDUL</label>
                                            <input type="text" class="form-control" placeholder="JUDUL" autofocus
                                                name="subject" />
                                        </div>
                                    </div>
                                    <div class="col-xs-12">
                                        <div class="wrapper">
                                            ...
                                            <div class="options">
                                                <input class="editor_font" type="number"
                                                    onChange="return transform('fontSize', this.value)" value="3"
                                                    max="7" min="1"></input>
                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <div class="fileUpload">
                                            <label for="file-upload">PILIH FILE<input type="file" multiple
                                                    id="file-upload" name='attachments[]'></label>
    ...
    @slot('js')
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                //table no data text center align      
