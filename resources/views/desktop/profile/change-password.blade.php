            ...
            <div class="container-b3">
                ...
                <div class="row chg-pass">
                    <div class="col-xs-12 offset-lg-3 col-lg-6">
                        <form id="chgPwdForm" class="needs-validation" method="POST"
                            action="{{ url('chg-pass') }}">
                            @csrf
                            <div class="form-group row no-gutters">
                                <label for="CurrentPwd" class="col-md-5 col-form-label text-left"
                                    i18n>Kata sandi saat ini<span
                            ...
                            <div class="form-group row no-gutters">
                                <label for="newPwd"
                                    class="col-xs-12 col-md-5 col-form-label  text-left" i18n>kata
                                    sandi baru<span class="text-danger">&nbsp;*&nbsp;</span></label>
                                <!--TODO currency-->
                                <div class="col-xs-12 col-md-7">
                                    ...
                                    <small class="text-left">* Minimal 8 karakter dan memiliki min 1
                                        alfabet, 1 angka dan 1 karakter khusus (!@#$%^&amp;*()_+)
                                    </small>
                            ...
                            <div class="form-group row no-gutters">
                                <label for="ConfirmPwd"
                                    class="col-xs-12  col-md-5 col-form-label  text-left">konfirmasi
