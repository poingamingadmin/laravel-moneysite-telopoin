                        ...
                        <form id="searchhistory" class="needs-validation searchhistory ref_downline_srch">
                            ...
                            <div class="box-wrapper plr-15">
                                ...
                                <div class="row d-flex align-items-center">
                                    ...
                                    <div class="col-md-9 col-xs-8 d-flex flex-wrap">
                                        <button type="submit" class="btn btn-primary m-15">Cari
                                            Pesan Disini</button>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-md-12">
                        <div id="historySearchResult" class="m-tb-15">
                            <table
                                ...
                                role="grid" aria-describedby="historyDataTable_info" id="referral-table">
            ...
            $(document).ready(function() {
                ...
                $("#searchhistory").validate({
                    ...
                    submitHandler: function(form) {
                        ...
                        $.post('{{ url('getReferalDownline') }}', $('#searchhistory')
                            .serialize(),
                            function(data) {
