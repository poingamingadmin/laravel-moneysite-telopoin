        ...
        <div class="register container">
            <div class="row">
                ...
                <div class="col-md-6 clearfix">
                    <div class="p-title">
                        <span id="step_title" class="skew" data-title="Daftar Akun"> <span>Daftar Akun
                            </span></span>
                    </div>
                        ...
                        <div class="register_form_one">
                            ...
                            <div class="form-group  ">
                                ...
                                <div class="col-md-7">
                                    ...
                                    <small class="text-left">
                                        * Nama akun harus 6-12 karakter, hanya menggunakan huruf dan/atau angka (0-9)
                                        dan tidak ada simbol (@#$~%&) <br> cth : <b>namaakun1</b>
                                    </small>
                            ...
                            <div class="form-group  ">
                                ...
                                <div class="col-md-7">
                                    ...
                                    <small class="text-left">* Minimal 8 karakter dan memiliki min 1 alfabet, 1 angka
                                        dan 1 karakter khusus (!@#$%^&amp;*()_+) <br> cth : <b>password1@</b> </small>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-md-5">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    ...
                                    <small class="text-left">* Silakan isi alamat email yang benar untuk keperluan
                                        Lupa Password </small>
                        ...
                        <div class="register_form_two">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    ...
                                    <small class="text-left">* Nama yang terdaftar harus sesuai dengan nama rekening
                                        bank yang digunakan untuk menyetor dan menarik dana.</small>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-md-5 ">
                                    <label for="acc_type" style="padding-top: 7.5px;">Jenis Akun Transaksi<span
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    ...
                                    <small class="text-left">* Pastikan rekening anda Valid, Aktif, dan belum
                                        terdaftar di situs ini </small>
                                </div>
                            </div>
                                ...
                                <div class="col-md-12">
                                    <div class="checkbox">
                                        <label><input type="checkbox" id="terms" name="terms" value= "on">
                                            &nbsp;Dengan memilih tombol DAFTAR, saya menyatakan
                                            bahwa saya berusia 18 tahun atau lebih. Saya telah membaca dan menyetujui
                                            Syarat & Ketentuan. Lihat <a
